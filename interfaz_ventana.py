...
class En_ProcesoScreen(Screen):
    ...
    def action_insertar(self):
        ...
        self.app.push_screen(InsertarScreen2())
...
class TerminadosScreen(Screen):
    ...
    def action_insertar(self):
        ...
        self.app.push_screen(InsertarScreen3())
...
class InsertarScreen2(Screen):
    ...
    async def on_button_pressed(self, event: Button.Pressed) -> None:
        if event.button.id == "cancelar":
            ...
            self.app.push_screen(QuitScreen2(self.titulo_input.value, self.contenido_input.value))
                
class QuitScreen2(Screen):
    def __init__(self, titulo_input_value, contenido_input_value):
        super().__init__()
        self.titulo_input_value = titulo_input_value
        self.contenido_input_value = contenido_input_value
...
class InsertarScreen3(Screen):
    ...
    async def on_button_pressed(self, event: Button.Pressed) -> None:
        if event.button.id == "cancelar":
            ...
            self.app.push_screen(QuitScreen3(self.titulo_input.value, self.contenido_input.value))
                
class QuitScreen3(Screen):
    def __init__(self, titulo_input_value, contenido_input_value):
        super().__init__()
        self.titulo_input_value = titulo_input_value
        self.contenido_input_value = contenido_input_value
